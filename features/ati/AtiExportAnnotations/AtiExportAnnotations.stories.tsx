...
export default {
  component: AtiExportAnnotations,
  title: "ATI/ATI Export Annotations",
} as Meta

const Template: Story<AtiExportAnnotationstProps> = (args) => <AtiExportAnnotations {...args} />
